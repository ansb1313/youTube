...
const OverlaySideMenu = ({withIconMenu}) => {

    const {overlaySidebar} = useSelector(state => state.app)
    ...
    return (
        <Container className={'overlayMenuContainer'}>
            <Screen onClick={onClose} className={cn({isActive:overlaySidebar})} />
            {
                withIconMenu &&
                <IconMenuContainer>
                    <IconSideMenu/>
            ...
            <TextMenuContainer className={cn('textMenuContainer',{isActive:overlaySidebar})} >
