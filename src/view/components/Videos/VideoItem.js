...
const VideoItem = (props) => {
    ...
    const viewCount =
        statistics.viewCount / 10000 > 1 ? thousandNumberFormat(tenThousandFormat(statistics.viewCount)) + "만" : thousandNumberFormat(statistics.viewCount);
        ...
        <Container onClick={onClick}>
            <Thumb>
                ...
                <ThumbnailMenu>
                    <div className="laterIcon">
                        <div
                            className={cn("text", { isActive: mouseOverClass })}
                        ...
                        <div
                            className={cn("icon", { isActive: mouseOverClass })}
                            onMouseOver={onMouseOver}
                            onMouseLeave={onMouseOut}
                            onClick={(e) => {
                                e.stopPropagation();
                    ...
                    <div className="listIcon">
                        <div
                            className="text"
                            className={cn("text", { isActive: mouseOver })}
                            onMouseOver={onMouse}
                        ...
                        <div
                            className={cn("icon", { isActive: mouseOver })}
                            onMouseOver={onMouse}
                            onMouseLeave={onMouseLeave}
                            onClick={(e) => {
                                e.stopPropagation();
            ...
            <Desc>
                ...
                <Info>
                    ...
                    <p>
                        조회수{viewCount}회 {dateFromNow(snippet?.publishedAt)}
                    </p>
                    <InfoMoreMenu
                        className={"moreMenu"}
                        onClick={(e) => {
